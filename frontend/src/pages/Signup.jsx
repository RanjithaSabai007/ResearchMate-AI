...
import { Key, User, Mail, ShieldCheck, AlertCircle, FileText, Database, ShieldAlert } from 'lucide-react';
        ...
        <div className="space-y-8 my-auto">
          <div className="space-y-4 animate-fade-in-up delay-100">
            ...
            <p className="text-gray-300 text-md leading-relaxed max-w-lg font-medium">
              Create an account with ResearchMate AI to start building your secure research repository. Keep track of authors, abstracts, domains, and keywords seamlessly in a unified workspace.
            </p>
          </div>
          ...
          <div className="space-y-5 animate-fade-in-up delay-200">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 text-sm">Dynamic Metadata Hub</h4>
                <p className="text-xs text-gray-400 mt-1 max-w-sm">Capture key details for each of your research sources, including titles, authors, keywords, and abstracts.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 text-sm">Profile Cryptography</h4>
                <p className="text-xs text-gray-400 mt-1 max-w-sm">Passwords and sensitive user details are encrypted at rest with column-level storage protection.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 text-sm">Active Session Inspector</h4>
                <p className="text-xs text-gray-400 mt-1 max-w-sm">Gain insight into active connections, detect logins, and revoke remote session tokens at any time.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 relative">
        ...
        <div className="w-full max-w-md bg-white rounded-3xl border border-gray-100 shadow-xl p-8 hover:shadow-2xl transition-all duration-300 animate-fade-in-up delay-100">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1.5 font-medium text-center">Join ResearchMate AI to organize your academic papers</p>
          </div>
